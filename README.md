...
> EI is a mechanism that allows everyone's work to be price-tagged and prices to be automatically obtained at a fair and efficient price.

We showed you the core elements of the mechanic and demonstrated it through the game.

We have borrowed the code of [The Evolution of Trust](https://github.com/ncase/trust), and developed it twice, thanks to.
...
* [The Evolution of Trust](https://github.com/ncase/trust) for framework (CC Zero)
